import { n as __commonJSMin, t as require_react$1 } from "./react-DW0Z4HR0.js";
//#region node_modules/keen-slider/react.js
var require_react = /* @__PURE__ */ __commonJSMin(((exports) => {
	Object.defineProperty(exports, "__esModule", { value: !0 });
	var n = require_react$1();
	function t(n) {
	...
	function g(n) {
		...
		function l() {
			var t = a;
			window.cancelAnimationFrame(t), c(!1), s(null), o && n.emit("animationStopped"), o = null;
		}
		return t = {
			active: !1,
			start: function(t) {
	...
	function b(n) {
		var t, e, r, a, o, u, c, l, v, h, g, b, y, x, k = Infinity, w = [], M = null, T = 0;
		function C(n) {
			P(T + n);
		}
		function E(n) {
		...
		function A(n, t) {
			if (t ??= p(T), !O(n) || null === n) return null;
			n = Math.round(n);
		...
		return t = {
			...
			init: function(t) {
				...
				(function() {
					...
					g = v = e ? f(e, "min", -Infinity) : 0, b = h = e ? f(e, "max", k) : l;
					var i = f(t, "min", null), r = f(t, "max", null);
					null !== i && (v = i), null !== r && (h = r), y = v === -Infinity ? v : n.track.idxToDist(v || 0, !0, 0), x = h === k ? h : I(h, !0, 0), null === r && (b = h), f(t, "align", !1) && h !== k && 0 === o[L(h)][2] && (x -= 1 - o[L(h)][0], h = E(x - T)), y = p(y), x = p(x);
	...
	function x(n) {
		...
		function E(t) {
			if (f && v === t.id) {
				...
				o(t);
				var c = function(t) {
					if (M === -Infinity && T === Infinity) return t;
		...
		function P() {
			if (C.purge(), n.options.drag && !n.options.disabled) {
				var e = n.options.dragSpeed || 1;
				p = "function" == typeof e ? e : function(n) {
					return n * e;
				...
				a("[".concat(r, "]:not([").concat(r, "=false])"), n.container).map((function(n) {
					return function(n) {
						...
						C.input(n, "touchstart", (function(n) {
							t = O(n), w = !0, k = !0;
						}), { passive: !0 }), C.input(n, "touchmove", (function(e) {
